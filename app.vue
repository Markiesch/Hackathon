<template>
  <Head>
    <Title>Eventz</Title>
    <Meta name="author" content="The Crazy Goblins" />
    <Meta name="description" content="Evenementen voor eenzamelingen" />
    <Meta name="keywords" content="evenementen, hackathon, eenzaam, eenzaamheid" />
